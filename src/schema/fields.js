...
export const FORM_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "month", label: "Месяц", required: true, placeholder: "01–12", help: "Месяц акта." },
      { name: "year", label: "Год", required: true, placeholder: "ГГГГ", help: "Год акта (4 цифры)." }
    ]
  },
  {
    id: "partyService",
  ...
  },
  {
    ...
    fields: [
      { name: "amount", label: "Полная стоимость", required: true,
        placeholder: "Напр.: 1 500 000", help: "Итоговая стоимость по договору." },
      ...
      { name: "paymentAmount", label: "Сумма оплаты", required: true,
        placeholder: "Напр.: 1 200 000", help: "Сумма к выплате по акту." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "issDay", label: "День выдачи", required: true, placeholder: "01–31", help: "День выдачи паспорта." },
      { name: "issMonth", label: "Месяц выдачи", required: true, placeholder: "01–12", help: "Месяц выдачи паспорта." },
      { name: "issYear", label: "Год выдачи", required: true, placeholder: "ГГГГ", help: "Год выдачи паспорта (4 цифры)." },
  ...
  },
  {
    ...
    fields: [
      { name: "pinfl", label: "ПИНФЛ", required: true,
        placeholder: "14 цифр", help: "Идентификационный номер физ.лица (14 цифр)." },
      { name: "bankCard", label: "Банковская карта", required: true,
        placeholder: "16 цифр", help: "Номер карты для зачисления." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "servicesDateStart", label: "Дата начала услуги", placeholder: "ДД.ММ.ГГГГ", help: "Если требуется шаблоном." },
      ...
      { name: "issDate", label: "Дата выдачи (цельная)", placeholder: "ДД.ММ.ГГГГ", help: "Альтернатива issDay/issMonth/issYear." },
